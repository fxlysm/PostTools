...
public class WechatWapPay {
	public static String NormalPost(String posturl, String service, String cpId, String totalFee, String cpOrderId,
			String mchCreateIp, String notifyUrl, String body, String nonceStr, String key,String signtype) {
...
//		System.out.println(ss);
	...
	public static String noneed_parameter_post(String posturl, String service, String cpId, String totalFee,
			String cpOrderId, String mchCreateIp, String notifyUrl, String body, String nonceStr, String inputCharset,
			String signType, String currency, String attach,String opShopId,String limitCreditPay, String platform, String key) {
		...
		cacheMap.put("opShopId", opShopId);
