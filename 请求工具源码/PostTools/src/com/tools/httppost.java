...
public class httppost extends JFrame {
	...
	public httppost() {
		...
		textField_posturl.setText("http://192.168.70.87:8070/payment-gate-web/gateway/api/backTransReq");
...
//				}
				...
				String poststrString=PostTools.httpRequest(posturl, "POST", parameter);
				textArea_backstr.setText(poststrString);
